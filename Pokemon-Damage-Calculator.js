/*
  ...
  Your task is to calculate the damage that a particular move would do using the following formula (not the actual one from the game):
...
function calculateDamage(yourType, opponentType, attack, defense){
  const effectiveness = yourType === opponentType ? 0.5 : typesEffectiveness[yourType][opponentType];
